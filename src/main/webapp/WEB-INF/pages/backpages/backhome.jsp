...
<head>
    ...
    <!-- BOOTSTRAP STYLES-->
    <link href="${ctx}/staticfile/backpages/css/bootstrap.css" rel="stylesheet" />
    <!-- FONTAWESOME STYLES-->
    <link href="${ctx}/staticfile/backpages/css/font-awesome.css" rel="stylesheet" />
       <!--CUSTOM BASIC STYLES-->
    <link href="${ctx}/staticfile/backpages/css/basic.css" rel="stylesheet" />
    <!--CUSTOM MAIN STYLES-->
    <link href="${ctx}/staticfile/backpages/css/custom.css" rel="stylesheet" />
    <!-- GOOGLE FONTS-->
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="backhome.jsp">COMPANY NAME</a>
            </div>
                ...
                <ul class="nav" id="main-menu">
                    <li>
                        <div class="user-img-div">
                            <img src="${ctx}/staticfile/backpages/img/user.png" class="img-thumbnail" />
                    ...
                    <li>
                        <a class="active-menu" href="backhome.jsp"><i class="fa fa-dashboard "></i>Dashboard</a>
                    </li>
                    <li>
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            ...
                                            <div class="col-md-10 col-md-offset-1">
                                                ...
                                                <div class="user-img pull-right">
                                                    <img src="${ctx}/staticfile/backpages/img/user.gif" alt="" class="img-u image-responsive" />
                                                </div>
                                        ...
                                        <div class="item">
                                            <div class="col-md-10 col-md-offset-1">
                                                ...
                                                <h4><i class="fa fa-quote-left"></i>Lorem ipsum dolor sit amet, consectetur adipiscing Lorem ipsum dolor sit amet, consectetur adipiscing elit onec molestie non sem vel condimentum. <i class="fa fa-quote-right"></i></h4>
                                                <div class="user-img pull-right">
                                                    <img src="${ctx}/staticfile/backpages/img/user.png" alt="" class="img-u image-responsive" />
                                                </div>
                                                <h5 class="pull-right"><strong class="c-black">Lorem Dolor</strong></h5>
                                            </div>
                            ...
                            <div id="carousel-example" class="carousel slide" data-ride="carousel" style="border: 5px solid #000;">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        ...
                                        <img src="${ctx}/staticfile/backpages/img/slideshow/1.jpg" alt="" />

                                    </div>
                                    <div class="item">
                                        <img src="${ctx}/staticfile/backpages/img/slideshow/2.jpg" alt="" />

                                    </div>
                                    <div class="item">
                                        <img src="${ctx}/staticfile/backpages/img/slideshow/3.jpg" alt="" />
        ...
        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle img-comments" src="${ctx}/staticfile/backpages/img/user.png" />
                                                </a>
                                                <div class="media-body">
              ...
              <!-- Nested media object -->
                                                    <div class="media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object img-circle img-comments" src="${ctx}/staticfile/backpages/img/user.gif" />
                                                        </a>
                                                        <div class="media-body">
    ...
    <!-- JQUERY SCRIPTS -->
    <script src="${ctx}/staticfile/backpages/js/jquery-1.10.2.js"></script>
    <!-- BOOTSTRAP SCRIPTS -->
    <script src="${ctx}/staticfile/backpages/js/bootstrap.js"></script>
    <!-- METISMENU SCRIPTS -->
    <script src="${ctx}/staticfile/backpages/js/jquery.metisMenu.js"></script>
       <!-- CUSTOM SCRIPTS -->
    <script src="${ctx}/staticfile/backpages/js/custom.js"></script>
